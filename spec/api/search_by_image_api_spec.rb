...
# Unit tests for OpenapiClient::SearchByImageApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SearchByImageApi' do
  before do
  ...
  describe 'test an instance of SearchByImageApi' do
    it 'should create an instance of SearchByImageApi' do
      expect(@api_instance).to be_instance_of(BuyBrowseApiClient::SearchByImageApi)
    end
  end
