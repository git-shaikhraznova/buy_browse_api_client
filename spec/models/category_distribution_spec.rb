...
# Unit tests for OpenapiClient::CategoryDistribution
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CategoryDistribution' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::CategoryDistribution.new
  end
  ...
  describe 'test an instance of CategoryDistribution' do
    it 'should create an instance of CategoryDistribution' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::CategoryDistribution)
    end
  end
