...
# Unit tests for OpenapiClient::ItemLocationImpl
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ItemLocationImpl' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::ItemLocationImpl.new
  end
  ...
  describe 'test an instance of ItemLocationImpl' do
    it 'should create an instance of ItemLocationImpl' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::ItemLocationImpl)
    end
  end
