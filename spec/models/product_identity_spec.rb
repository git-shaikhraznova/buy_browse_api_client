...
# Unit tests for OpenapiClient::ProductIdentity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProductIdentity' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::ProductIdentity.new
  end
  ...
  describe 'test an instance of ProductIdentity' do
    it 'should create an instance of ProductIdentity' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::ProductIdentity)
    end
  end
