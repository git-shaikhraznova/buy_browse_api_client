...
# Unit tests for OpenapiClient::RangeValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RangeValue' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::RangeValue.new
  end
  ...
  describe 'test an instance of RangeValue' do
    it 'should create an instance of RangeValue' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::RangeValue)
    end
  end
  ...
  describe 'test attribute "exclusive_end"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "exclusive_start"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
