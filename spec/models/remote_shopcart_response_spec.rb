...
# Unit tests for OpenapiClient::RemoteShopcartResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RemoteShopcartResponse' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::RemoteShopcartResponse.new
  end
  ...
  describe 'test an instance of RemoteShopcartResponse' do
    it 'should create an instance of RemoteShopcartResponse' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::RemoteShopcartResponse)
    end
  end
  ...
  describe 'test attribute "cart_subtotal"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "cart_web_url"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "unavailable_cart_items"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
