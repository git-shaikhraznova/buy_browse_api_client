...
# Unit tests for OpenapiClient::ItemGroupSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ItemGroupSummary' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::ItemGroupSummary.new
  end
  ...
  describe 'test an instance of ItemGroupSummary' do
    it 'should create an instance of ItemGroupSummary' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::ItemGroupSummary)
    end
  end
  describe 'test attribute "item_group_additional_images"' do
    it 'should work' do
  ...
  describe 'test attribute "item_group_image"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
