...
# Unit tests for OpenapiClient::ShippingOptionSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ShippingOptionSummary' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::ShippingOptionSummary.new
  end
  ...
  describe 'test an instance of ShippingOptionSummary' do
    it 'should create an instance of ShippingOptionSummary' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::ShippingOptionSummary)
    end
  end
