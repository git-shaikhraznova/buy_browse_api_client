...
# Unit tests for OpenapiClient::AttributeNameValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AttributeNameValue' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::AttributeNameValue.new
  end
  ...
  describe 'test an instance of AttributeNameValue' do
    it 'should create an instance of AttributeNameValue' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::AttributeNameValue)
    end
  end
