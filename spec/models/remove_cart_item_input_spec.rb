...
# Unit tests for OpenapiClient::RemoveCartItemInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RemoveCartItemInput' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::RemoveCartItemInput.new
  end
  ...
  describe 'test an instance of RemoveCartItemInput' do
    it 'should create an instance of RemoveCartItemInput' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::RemoveCartItemInput)
    end
  end
  describe 'test attribute "cart_item_id"' do
    it 'should work' do
