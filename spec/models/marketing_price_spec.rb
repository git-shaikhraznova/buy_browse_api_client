...
# Unit tests for OpenapiClient::MarketingPrice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'MarketingPrice' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::MarketingPrice.new
  end
  ...
  describe 'test an instance of MarketingPrice' do
    it 'should create an instance of MarketingPrice' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::MarketingPrice)
    end
  end
