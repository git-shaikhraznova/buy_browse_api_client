...
# Unit tests for OpenapiClient::SearchByImageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SearchByImageRequest' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::SearchByImageRequest.new
  end
  ...
  describe 'test an instance of SearchByImageRequest' do
    it 'should create an instance of SearchByImageRequest' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::SearchByImageRequest)
    end
  end
