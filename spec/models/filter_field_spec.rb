...
# Unit tests for OpenapiClient::FilterField
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FilterField' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::FilterField.new
  end
  ...
  describe 'test an instance of FilterField' do
    it 'should create an instance of FilterField' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::FilterField)
    end
  end
