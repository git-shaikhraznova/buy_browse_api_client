...
# Unit tests for OpenapiClient::ShipToLocation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ShipToLocation' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::ShipToLocation.new
  end
  ...
  describe 'test an instance of ShipToLocation' do
    it 'should create an instance of ShipToLocation' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::ShipToLocation)
    end
  end
