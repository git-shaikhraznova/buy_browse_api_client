...
# Unit tests for OpenapiClient::TimeDuration
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TimeDuration' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::TimeDuration.new
  end
  ...
  describe 'test an instance of TimeDuration' do
    it 'should create an instance of TimeDuration' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::TimeDuration)
    end
  end
