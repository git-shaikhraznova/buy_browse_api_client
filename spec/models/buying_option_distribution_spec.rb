...
# Unit tests for OpenapiClient::BuyingOptionDistribution
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BuyingOptionDistribution' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::BuyingOptionDistribution.new
  end
  ...
  describe 'test an instance of BuyingOptionDistribution' do
    it 'should create an instance of BuyingOptionDistribution' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::BuyingOptionDistribution)
    end
  end
  describe 'test attribute "buying_option"' do
    it 'should work' do
