...
# Unit tests for OpenapiClient::ErrorParameterV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ErrorParameterV3' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::ErrorParameterV3.new
  end
  ...
  describe 'test an instance of ErrorParameterV3' do
    it 'should create an instance of ErrorParameterV3' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::ErrorParameterV3)
    end
  end
