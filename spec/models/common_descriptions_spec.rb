...
# Unit tests for OpenapiClient::CommonDescriptions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CommonDescriptions' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::CommonDescriptions.new
  end
  ...
  describe 'test an instance of CommonDescriptions' do
    it 'should create an instance of CommonDescriptions' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::CommonDescriptions)
    end
  end
