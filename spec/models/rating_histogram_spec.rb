...
# Unit tests for OpenapiClient::RatingHistogram
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RatingHistogram' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::RatingHistogram.new
  end
  ...
  describe 'test an instance of RatingHistogram' do
    it 'should create an instance of RatingHistogram' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::RatingHistogram)
    end
  end
