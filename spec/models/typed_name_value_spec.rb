...
# Unit tests for OpenapiClient::TypedNameValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TypedNameValue' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::TypedNameValue.new
  end
  ...
  describe 'test an instance of TypedNameValue' do
    it 'should create an instance of TypedNameValue' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::TypedNameValue)
    end
  end
