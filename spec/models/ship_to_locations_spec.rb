...
# Unit tests for OpenapiClient::ShipToLocations
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ShipToLocations' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::ShipToLocations.new
  end
  ...
  describe 'test an instance of ShipToLocations' do
    it 'should create an instance of ShipToLocations' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::ShipToLocations)
    end
  end
  describe 'test attribute "region_excluded"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "region_included"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
