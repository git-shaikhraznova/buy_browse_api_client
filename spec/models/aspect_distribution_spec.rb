...
# Unit tests for OpenapiClient::AspectDistribution
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AspectDistribution' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::AspectDistribution.new
  end
  ...
  describe 'test an instance of AspectDistribution' do
    it 'should create an instance of AspectDistribution' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::AspectDistribution)
    end
  end
  describe 'test attribute "aspect_value_distributions"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "localized_aspect_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
