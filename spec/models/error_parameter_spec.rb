...
# Unit tests for OpenapiClient::ErrorParameter
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ErrorParameter' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::ErrorParameter.new
  end
  ...
  describe 'test an instance of ErrorParameter' do
    it 'should create an instance of ErrorParameter' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::ErrorParameter)
    end
  end
