...
# Unit tests for OpenapiClient::CartItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CartItem' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::CartItem.new
  end
  ...
  describe 'test an instance of CartItem' do
    it 'should create an instance of CartItem' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::CartItem)
    end
  end
  ...
  describe 'test attribute "cart_item_subtotal"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
