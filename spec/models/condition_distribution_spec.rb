...
# Unit tests for OpenapiClient::ConditionDistribution
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ConditionDistribution' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::ConditionDistribution.new
  end
  ...
  describe 'test an instance of ConditionDistribution' do
    it 'should create an instance of ConditionDistribution' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::ConditionDistribution)
    end
  end
