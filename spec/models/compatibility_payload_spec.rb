...
# Unit tests for OpenapiClient::CompatibilityPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CompatibilityPayload' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::CompatibilityPayload.new
  end
  ...
  describe 'test an instance of CompatibilityPayload' do
    it 'should create an instance of CompatibilityPayload' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::CompatibilityPayload)
    end
  end
  describe 'test attribute "compatibility_properties"' do
    it 'should work' do
