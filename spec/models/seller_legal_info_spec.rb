...
# Unit tests for OpenapiClient::SellerLegalInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SellerLegalInfo' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::SellerLegalInfo.new
  end
  ...
  describe 'test an instance of SellerLegalInfo' do
    it 'should create an instance of SellerLegalInfo' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::SellerLegalInfo)
    end
  end
  ...
  describe 'test attribute "legal_contact_first_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "legal_contact_last_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "seller_provided_legal_address"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "vat_details"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
