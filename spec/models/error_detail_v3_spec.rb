...
# Unit tests for OpenapiClient::ErrorDetailV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ErrorDetailV3' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::ErrorDetailV3.new
  end
  ...
  describe 'test an instance of ErrorDetailV3' do
    it 'should create an instance of ErrorDetailV3' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::ErrorDetailV3)
    end
  end
  ...
  describe 'test attribute "input_ref_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "long_message"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "output_ref_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
