...
# Unit tests for OpenapiClient::AspectValueDistribution
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AspectValueDistribution' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::AspectValueDistribution.new
  end
  ...
  describe 'test an instance of AspectValueDistribution' do
    it 'should create an instance of AspectValueDistribution' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::AspectValueDistribution)
    end
  end
  describe 'test attribute "localized_aspect_value"' do
    it 'should work' do
  ...
  describe 'test attribute "refinement_href"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
