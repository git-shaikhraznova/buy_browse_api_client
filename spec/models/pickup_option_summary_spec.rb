...
# Unit tests for OpenapiClient::PickupOptionSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PickupOptionSummary' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::PickupOptionSummary.new
  end
  ...
  describe 'test an instance of PickupOptionSummary' do
    it 'should create an instance of PickupOptionSummary' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::PickupOptionSummary)
    end
  end
  describe 'test attribute "pickup_location_type"' do
    it 'should work' do
