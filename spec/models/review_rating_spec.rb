...
# Unit tests for OpenapiClient::ReviewRating
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReviewRating' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::ReviewRating.new
  end
  ...
  describe 'test an instance of ReviewRating' do
    it 'should create an instance of ReviewRating' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::ReviewRating)
    end
  end
  ...
  describe 'test attribute "rating_histograms"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
