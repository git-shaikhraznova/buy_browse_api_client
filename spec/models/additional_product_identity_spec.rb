...
# Unit tests for OpenapiClient::AdditionalProductIdentity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AdditionalProductIdentity' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::AdditionalProductIdentity.new
  end
  ...
  describe 'test an instance of AdditionalProductIdentity' do
    it 'should create an instance of AdditionalProductIdentity' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::AdditionalProductIdentity)
    end
  end
  describe 'test attribute "product_identity"' do
    it 'should work' do
