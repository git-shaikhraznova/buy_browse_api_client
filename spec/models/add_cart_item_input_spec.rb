...
# Unit tests for OpenapiClient::AddCartItemInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AddCartItemInput' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::AddCartItemInput.new
  end
  ...
  describe 'test an instance of AddCartItemInput' do
    it 'should create an instance of AddCartItemInput' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::AddCartItemInput)
    end
  end
