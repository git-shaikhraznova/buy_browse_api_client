...
# Unit tests for OpenapiClient::ItemReturnTerms
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ItemReturnTerms' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::ItemReturnTerms.new
  end
  ...
  describe 'test an instance of ItemReturnTerms' do
    it 'should create an instance of ItemReturnTerms' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::ItemReturnTerms)
    end
  end
  describe 'test attribute "extended_holiday_returns_offered"' do
    it 'should work' do
  ...
  describe 'test attribute "restocking_fee_percentage"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "return_instructions"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "return_method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "return_period"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "return_shipping_cost_payer"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
