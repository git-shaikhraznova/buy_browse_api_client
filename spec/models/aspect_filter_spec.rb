...
# Unit tests for OpenapiClient::AspectFilter
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AspectFilter' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::AspectFilter.new
  end
  ...
  describe 'test an instance of AspectFilter' do
    it 'should create an instance of AspectFilter' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::AspectFilter)
    end
  end
