...
# Unit tests for OpenapiClient::SellerDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SellerDetail' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::SellerDetail.new
  end
  ...
  describe 'test an instance of SellerDetail' do
    it 'should create an instance of SellerDetail' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::SellerDetail)
    end
  end
  describe 'test attribute "feedback_percentage"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "feedback_score"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "seller_account_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "seller_legal_info"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
