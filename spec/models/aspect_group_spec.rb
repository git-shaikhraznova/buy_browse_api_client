...
# Unit tests for OpenapiClient::AspectGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AspectGroup' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::AspectGroup.new
  end
  ...
  describe 'test an instance of AspectGroup' do
    it 'should create an instance of AspectGroup' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::AspectGroup)
    end
  end
  ...
  describe 'test attribute "localized_group_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
