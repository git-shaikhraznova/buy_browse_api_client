...
# Unit tests for OpenapiClient::VatDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VatDetail' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::VatDetail.new
  end
  ...
  describe 'test an instance of VatDetail' do
    it 'should create an instance of VatDetail' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::VatDetail)
    end
  end
