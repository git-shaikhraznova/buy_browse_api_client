...
# Unit tests for OpenapiClient::Aspect
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Aspect' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::Aspect.new
  end
  ...
  describe 'test an instance of Aspect' do
    it 'should create an instance of Aspect' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::Aspect)
    end
  end
  ...
  describe 'test attribute "localized_values"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
