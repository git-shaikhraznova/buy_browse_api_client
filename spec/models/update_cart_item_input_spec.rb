...
# Unit tests for OpenapiClient::UpdateCartItemInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UpdateCartItemInput' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::UpdateCartItemInput.new
  end
  ...
  describe 'test an instance of UpdateCartItemInput' do
    it 'should create an instance of UpdateCartItemInput' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::UpdateCartItemInput)
    end
  end
