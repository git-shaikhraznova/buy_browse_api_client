...
# Unit tests for OpenapiClient::CompatibilityResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CompatibilityResponse' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::CompatibilityResponse.new
  end
  ...
  describe 'test an instance of CompatibilityResponse' do
    it 'should create an instance of CompatibilityResponse' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::CompatibilityResponse)
    end
  end
  describe 'test attribute "compatibility_status"' do
    it 'should work' do
