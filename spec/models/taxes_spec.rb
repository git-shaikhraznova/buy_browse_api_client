...
# Unit tests for OpenapiClient::Taxes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Taxes' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::Taxes.new
  end
  ...
  describe 'test an instance of Taxes' do
    it 'should create an instance of Taxes' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::Taxes)
    end
  end
  describe 'test attribute "ebay_collect_and_remit_tax"' do
    it 'should work' do
  ...
  describe 'test attribute "shipping_and_handling_taxed"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "tax_jurisdiction"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
