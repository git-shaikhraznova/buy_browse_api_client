...
# Unit tests for OpenapiClient::LegalAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'LegalAddress' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::LegalAddress.new
  end
  ...
  describe 'test an instance of LegalAddress' do
    it 'should create an instance of LegalAddress' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::LegalAddress)
    end
  end
