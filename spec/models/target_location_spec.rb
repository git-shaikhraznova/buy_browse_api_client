...
# Unit tests for OpenapiClient::TargetLocation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TargetLocation' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::TargetLocation.new
  end
  ...
  describe 'test an instance of TargetLocation' do
    it 'should create an instance of TargetLocation' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::TargetLocation)
    end
  end
