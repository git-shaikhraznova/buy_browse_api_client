...
# Unit tests for OpenapiClient::ConvertedAmount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ConvertedAmount' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::ConvertedAmount.new
  end
  ...
  describe 'test an instance of ConvertedAmount' do
    it 'should create an instance of ConvertedAmount' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::ConvertedAmount)
    end
  end
  describe 'test attribute "converted_from_currency"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "converted_from_value"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
