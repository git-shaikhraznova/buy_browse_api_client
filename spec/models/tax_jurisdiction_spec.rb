...
# Unit tests for OpenapiClient::TaxJurisdiction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TaxJurisdiction' do
  before do
    # run before each test
    @instance = BuyBrowseApiClient::TaxJurisdiction.new
  end
  ...
  describe 'test an instance of TaxJurisdiction' do
    it 'should create an instance of TaxJurisdiction' do
      expect(@instance).to be_instance_of(BuyBrowseApiClient::TaxJurisdiction)
    end
  end
  ...
  describe 'test attribute "tax_jurisdiction_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
