...
module BuyBrowseApiClient
  ...
  class Taxes
    ...
    attr_accessor :ebay_collect_and_remit_tax
    ...
    attr_accessor :shipping_and_handling_taxed

    attr_accessor :tax_jurisdiction
    ...
    def self.openapi_types
      {
        ...
        :'shipping_and_handling_taxed' => :'Boolean',
        :'tax_jurisdiction' => :'TaxJurisdiction',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Taxes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Taxes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'ebay_collect_and_remit_tax')
        self.ebay_collect_and_remit_tax = attributes[:'ebay_collect_and_remit_tax']
      end
      ...
      if attributes.key?(:'shipping_and_handling_taxed')
        self.shipping_and_handling_taxed = attributes[:'shipping_and_handling_taxed']
      end

      if attributes.key?(:'tax_jurisdiction')
        self.tax_jurisdiction = attributes[:'tax_jurisdiction']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          shipping_and_handling_taxed == o.shipping_and_handling_taxed &&
          tax_jurisdiction == o.tax_jurisdiction &&
    ...
    def hash
      [ebay_collect_and_remit_tax, included_in_price, shipping_and_handling_taxed, tax_jurisdiction, tax_percentage, tax_type].hash
    end
