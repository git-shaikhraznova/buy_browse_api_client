...
module BuyBrowseApiClient
  class CompatibilityPayload
    # An array of attribute name/value pairs used to define a specific product. For example: If you wanted to specify a specific car, one of the name/value pairs would be &quot;name&quot; : &quot;Year&quot;, &quot;value&quot; : &quot;2019&quot; For a list of the attributes required for Cars and Trucks and Motorcycles see Required Attributes.
    attr_accessor :compatibility_properties
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CompatibilityPayload` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CompatibilityPayload`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'compatibility_properties')
        if (value = attributes[:'compatibility_properties']).is_a?(Array)
          self.compatibility_properties = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          compatibility_properties == o.compatibility_properties
    end
