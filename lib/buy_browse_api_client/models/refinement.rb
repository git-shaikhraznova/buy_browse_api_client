...
module BuyBrowseApiClient
  ...
  class Refinement
    ...
    def self.openapi_types
      {
        :'aspect_distributions' => :'Array<AspectDistribution>',
        :'buying_option_distributions' => :'Array<BuyingOptionDistribution>',
        :'category_distributions' => :'Array<CategoryDistribution>',
        :'condition_distributions' => :'Array<ConditionDistribution>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Refinement` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Refinement`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'aspect_distributions')
        if (value = attributes[:'aspect_distributions']).is_a?(Array)
          self.aspect_distributions = value
        end
      end

      if attributes.key?(:'buying_option_distributions')
        if (value = attributes[:'buying_option_distributions']).is_a?(Array)
          self.buying_option_distributions = value
        end
      end

      if attributes.key?(:'category_distributions')
        if (value = attributes[:'category_distributions']).is_a?(Array)
          self.category_distributions = value
        end
      end

      if attributes.key?(:'condition_distributions')
        if (value = attributes[:'condition_distributions']).is_a?(Array)
          self.condition_distributions = value
        end
      end

      if attributes.key?(:'dominant_category_id')
        self.dominant_category_id = attributes[:'dominant_category_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          aspect_distributions == o.aspect_distributions &&
          buying_option_distributions == o.buying_option_distributions &&
          category_distributions == o.category_distributions &&
          condition_distributions == o.condition_distributions &&
          dominant_category_id == o.dominant_category_id
    end
    ...
    def hash
      [aspect_distributions, buying_option_distributions, category_distributions, condition_distributions, dominant_category_id].hash
    end
