...
module BuyBrowseApiClient
  ...
  class ShipToLocations
    ...
    def self.openapi_types
      {
        :'region_excluded' => :'Array<Region>',
        :'region_included' => :'Array<Region>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ShipToLocations` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ShipToLocations`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'region_excluded')
        if (value = attributes[:'region_excluded']).is_a?(Array)
          self.region_excluded = value
        end
      end

      if attributes.key?(:'region_included')
        if (value = attributes[:'region_included']).is_a?(Array)
          self.region_included = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          region_excluded == o.region_excluded &&
          region_included == o.region_included
    end
    ...
    def hash
      [region_excluded, region_included].hash
    end
