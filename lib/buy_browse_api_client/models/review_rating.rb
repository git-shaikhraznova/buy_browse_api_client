...
module BuyBrowseApiClient
  ...
  class ReviewRating
    ...
    attr_accessor :rating_histograms
    ...
    def self.openapi_types
      {
        ...
        :'rating_histograms' => :'Array<RatingHistogram>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ReviewRating` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ReviewRating`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'rating_histograms')
        if (value = attributes[:'rating_histograms']).is_a?(Array)
          self.rating_histograms = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rating_histograms == o.rating_histograms &&
    ...
    def hash
      [average_rating, rating_histograms, review_count].hash
    end
