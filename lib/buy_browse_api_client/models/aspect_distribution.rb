...
module BuyBrowseApiClient
  ...
  class AspectDistribution
    ...
    attr_accessor :aspect_value_distributions

    # Name of an aspect, such as Brand, Color, etc.
    attr_accessor :localized_aspect_name
    ...
    def self.openapi_types
      {
        :'aspect_value_distributions' => :'Array<AspectValueDistribution>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::AspectDistribution` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AspectDistribution`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'aspect_value_distributions')
        if (value = attributes[:'aspect_value_distributions']).is_a?(Array)
          self.aspect_value_distributions = value
        end
      end

      if attributes.key?(:'localized_aspect_name')
        self.localized_aspect_name = attributes[:'localized_aspect_name']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          aspect_value_distributions == o.aspect_value_distributions &&
          localized_aspect_name == o.localized_aspect_name
    end
    ...
    def hash
      [aspect_value_distributions, localized_aspect_name].hash
    end
