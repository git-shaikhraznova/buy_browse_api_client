...
module BuyBrowseApiClient
  ...
  class RemoteShopcartResponse
    ...
    attr_accessor :cart_subtotal

    # The URL of the member's eBay cart.
    attr_accessor :cart_web_url
    ...
    attr_accessor :unavailable_cart_items
    ...
    def self.openapi_types
      {
        ...
        :'cart_web_url' => :'String',
        :'unavailable_cart_items' => :'Array<CartItem>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::RemoteShopcartResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::RemoteShopcartResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cart_subtotal')
        self.cart_subtotal = attributes[:'cart_subtotal']
      end

      if attributes.key?(:'cart_web_url')
        self.cart_web_url = attributes[:'cart_web_url']
      end

      if attributes.key?(:'unavailable_cart_items')
        if (value = attributes[:'unavailable_cart_items']).is_a?(Array)
          self.unavailable_cart_items = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cart_subtotal == o.cart_subtotal &&
          cart_web_url == o.cart_web_url &&
          unavailable_cart_items == o.unavailable_cart_items &&
          warnings == o.warnings
    end
    ...
    def hash
      [cart_items, cart_subtotal, cart_web_url, unavailable_cart_items, warnings].hash
    end
