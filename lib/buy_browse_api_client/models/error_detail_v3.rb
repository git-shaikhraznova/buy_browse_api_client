  ...
  class ErrorDetailV3
    ...
    def self.openapi_types
      {
        ...
        :'domain' => :'String',
        :'error_id' => :'Integer',
        :'input_ref_ids' => :'Array<String>',
        :'long_message' => :'String',
        :'message' => :'String',
        :'output_ref_ids' => :'Array<String>',
        :'parameters' => :'Array<ErrorParameterV3>',
        :'subdomain' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ErrorDetailV3` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ErrorDetailV3`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'input_ref_ids')
        if (value = attributes[:'input_ref_ids']).is_a?(Array)
          self.input_ref_ids = value
        end
      end

      if attributes.key?(:'long_message')
        self.long_message = attributes[:'long_message']
      end
      ...
      if attributes.key?(:'output_ref_ids')
        if (value = attributes[:'output_ref_ids']).is_a?(Array)
          self.output_ref_ids = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          domain == o.domain &&
          error_id == o.error_id &&
          input_ref_ids == o.input_ref_ids &&
          long_message == o.long_message &&
          message == o.message &&
          output_ref_ids == o.output_ref_ids &&
    ...
    def hash
      [category, domain, error_id, input_ref_ids, long_message, message, output_ref_ids, parameters, subdomain].hash
    end
