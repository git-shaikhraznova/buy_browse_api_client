...
module BuyBrowseApiClient
  ...
  class ItemReturnTerms
    ...
    attr_accessor :extended_holiday_returns_offered
    ...
    def self.openapi_types
      {
        :'extended_holiday_returns_offered' => :'Boolean',
        :'refund_method' => :'RefundMethodEnum',
        :'restocking_fee_percentage' => :'String',
        :'return_instructions' => :'String',
        :'return_method' => :'ReturnMethodEnum',
        :'return_period' => :'TimeDuration',
        :'returns_accepted' => :'Boolean',
        :'return_shipping_cost_payer' => :'ReturnShippingCostPayerEnum'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ItemReturnTerms` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ItemReturnTerms`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'extended_holiday_returns_offered')
        self.extended_holiday_returns_offered = attributes[:'extended_holiday_returns_offered']
      end
      ...
      if attributes.key?(:'restocking_fee_percentage')
        self.restocking_fee_percentage = attributes[:'restocking_fee_percentage']
      end

      if attributes.key?(:'return_instructions')
        self.return_instructions = attributes[:'return_instructions']
      end

      if attributes.key?(:'return_method')
        self.return_method = attributes[:'return_method']
      end

      if attributes.key?(:'return_period')
        self.return_period = attributes[:'return_period']
      end

      if attributes.key?(:'returns_accepted')
        self.returns_accepted = attributes[:'returns_accepted']
      end

      if attributes.key?(:'return_shipping_cost_payer')
        self.return_shipping_cost_payer = attributes[:'return_shipping_cost_payer']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          extended_holiday_returns_offered == o.extended_holiday_returns_offered &&
          refund_method == o.refund_method &&
          restocking_fee_percentage == o.restocking_fee_percentage &&
          return_instructions == o.return_instructions &&
          return_method == o.return_method &&
          return_period == o.return_period &&
          returns_accepted == o.returns_accepted &&
          return_shipping_cost_payer == o.return_shipping_cost_payer
    end
    ...
    def hash
      [extended_holiday_returns_offered, refund_method, restocking_fee_percentage, return_instructions, return_method, return_period, returns_accepted, return_shipping_cost_payer].hash
    end
