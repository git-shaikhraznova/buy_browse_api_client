...
module BuyBrowseApiClient
  ...
  class Price
    attr_accessor :converted_from_currency
    ...
    attr_accessor :converted_from_value

    attr_accessor :currency

    # The dollar value of the currency specified in the currency field. The value of currency defaults to the standard currency used by the country of the eBay site offering the item. If currency conversion/localization was performed, this is the post-conversion amount. Default: The currency of the user's country.
    attr_accessor :value
    ...
    def self.openapi_types
      {
        :'converted_from_currency' => :'CurrencyCodeEnum',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Price`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'converted_from_currency')
        self.converted_from_currency = attributes[:'converted_from_currency']
      end

      if attributes.key?(:'converted_from_value')
        self.converted_from_value = attributes[:'converted_from_value']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          converted_from_currency == o.converted_from_currency &&
          converted_from_value == o.converted_from_value &&
          currency == o.currency &&
          value == o.value
    end
    ...
    def hash
      [converted_from_currency, converted_from_value, currency, value].hash
    end
