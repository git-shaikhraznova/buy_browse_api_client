...
module BuyBrowseApiClient
  class AspectGroup
    ...
    attr_accessor :localized_group_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::AspectGroup` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AspectGroup`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'localized_group_name')
        self.localized_group_name = attributes[:'localized_group_name']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          aspects == o.aspects &&
          localized_group_name == o.localized_group_name
    end
    ...
    def hash
      [aspects, localized_group_name].hash
    end
