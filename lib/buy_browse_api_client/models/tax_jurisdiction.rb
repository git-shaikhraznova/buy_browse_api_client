...
module BuyBrowseApiClient
  ...
  class TaxJurisdiction
    ...
    attr_accessor :tax_jurisdiction_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::TaxJurisdiction` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::TaxJurisdiction`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'tax_jurisdiction_id')
        self.tax_jurisdiction_id = attributes[:'tax_jurisdiction_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          region == o.region &&
          tax_jurisdiction_id == o.tax_jurisdiction_id
    end
    ...
    def hash
      [region, tax_jurisdiction_id].hash
    end
