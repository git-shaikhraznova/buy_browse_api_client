...
module BuyBrowseApiClient
  ...
  class Items
    ...
    attr_accessor :common_descriptions
    ...
    def self.openapi_types
      {
        :'common_descriptions' => :'Array<CommonDescriptions>',
        :'items' => :'Array<Item>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'common_descriptions')
        if (value = attributes[:'common_descriptions']).is_a?(Array)
          self.common_descriptions = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          common_descriptions == o.common_descriptions &&
          items == o.items
    end
    ...
    def hash
      [common_descriptions, items].hash
    end
