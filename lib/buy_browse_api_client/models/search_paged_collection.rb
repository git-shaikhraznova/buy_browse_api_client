...
module BuyBrowseApiClient
  # The type that defines the fields for a paginated result set. The response consists of 0 or more sequenced result sets where each result sets has 0 or more items.
  class SearchPagedCollection
    ...
    def self.openapi_types
      {
        :'href' => :'String',
        :'item_summaries' => :'Array<ItemSummary>',
        :'limit' => :'Integer',
        :'_next' => :'String',
        :'offset' => :'Integer',
        :'prev' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SearchPagedCollection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SearchPagedCollection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'item_summaries')
        if (value = attributes[:'item_summaries']).is_a?(Array)
          self.item_summaries = value
        end
      end
      ...
      if attributes.key?(:'refinement')
        self.refinement = attributes[:'refinement']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          href == o.href &&
          item_summaries == o.item_summaries &&
          limit == o.limit &&
          _next == o._next &&
          offset == o.offset &&
          prev == o.prev &&
    ...
    def hash
      [href, item_summaries, limit, _next, offset, prev, refinement, total, warnings].hash
    end
