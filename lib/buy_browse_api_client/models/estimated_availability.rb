...
module BuyBrowseApiClient
  ...
  class EstimatedAvailability
    ...
    attr_accessor :availability_threshold

    attr_accessor :availability_threshold_type
    ...
    attr_accessor :estimated_availability_status
    ...
    attr_accessor :estimated_available_quantity

    # The estimated number of this item that have been sold.
    attr_accessor :estimated_sold_quantity
    ...
    def self.openapi_types
      {
        ...
        :'availability_threshold_type' => :'AvailabilityThresholdEnum',
        :'delivery_options' => :'Array<DeliveryOptionsEnum>',
        :'estimated_availability_status' => :'AvailabilityStatusEnum',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::EstimatedAvailability` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::EstimatedAvailability`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'availability_threshold')
        self.availability_threshold = attributes[:'availability_threshold']
      end

      if attributes.key?(:'availability_threshold_type')
        self.availability_threshold_type = attributes[:'availability_threshold_type']
      end

      if attributes.key?(:'delivery_options')
        if (value = attributes[:'delivery_options']).is_a?(Array)
          self.delivery_options = value
        end
      end

      if attributes.key?(:'estimated_availability_status')
        self.estimated_availability_status = attributes[:'estimated_availability_status']
      end

      if attributes.key?(:'estimated_available_quantity')
        self.estimated_available_quantity = attributes[:'estimated_available_quantity']
      end

      if attributes.key?(:'estimated_sold_quantity')
        self.estimated_sold_quantity = attributes[:'estimated_sold_quantity']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          availability_threshold == o.availability_threshold &&
          availability_threshold_type == o.availability_threshold_type &&
          delivery_options == o.delivery_options &&
          estimated_availability_status == o.estimated_availability_status &&
          estimated_available_quantity == o.estimated_available_quantity &&
          estimated_sold_quantity == o.estimated_sold_quantity
    end
    ...
    def hash
      [availability_threshold, availability_threshold_type, delivery_options, estimated_availability_status, estimated_available_quantity, estimated_sold_quantity].hash
    end
