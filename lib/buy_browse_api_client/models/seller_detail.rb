...
module BuyBrowseApiClient
  ...
  class SellerDetail
    ...
    attr_accessor :seller_account_type

    attr_accessor :seller_legal_info
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SellerDetail` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SellerDetail`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'feedback_percentage')
        self.feedback_percentage = attributes[:'feedback_percentage']
      end

      if attributes.key?(:'feedback_score')
        self.feedback_score = attributes[:'feedback_score']
      end

      if attributes.key?(:'seller_account_type')
        self.seller_account_type = attributes[:'seller_account_type']
      end

      if attributes.key?(:'seller_legal_info')
        self.seller_legal_info = attributes[:'seller_legal_info']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          feedback_percentage == o.feedback_percentage &&
          feedback_score == o.feedback_score &&
          seller_account_type == o.seller_account_type &&
          seller_legal_info == o.seller_legal_info &&
          username == o.username
    end
    ...
    def hash
      [feedback_percentage, feedback_score, seller_account_type, seller_legal_info, username].hash
    end
