...
module BuyBrowseApiClient
  ...
  class SellerLegalInfo
    ...
    attr_accessor :legal_contact_first_name

    # The seller's last name.
    attr_accessor :legal_contact_last_name
    ...
    attr_accessor :seller_provided_legal_address
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SellerLegalInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SellerLegalInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'imprint')
        self.imprint = attributes[:'imprint']
      end

      if attributes.key?(:'legal_contact_first_name')
        self.legal_contact_first_name = attributes[:'legal_contact_first_name']
      end

      if attributes.key?(:'legal_contact_last_name')
        self.legal_contact_last_name = attributes[:'legal_contact_last_name']
      end
      ...
      if attributes.key?(:'seller_provided_legal_address')
        self.seller_provided_legal_address = attributes[:'seller_provided_legal_address']
      end
      ...
      if attributes.key?(:'vat_details')
        if (value = attributes[:'vat_details']).is_a?(Array)
          self.vat_details = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fax == o.fax &&
          imprint == o.imprint &&
          legal_contact_first_name == o.legal_contact_first_name &&
          legal_contact_last_name == o.legal_contact_last_name &&
          name == o.name &&
          phone == o.phone &&
          registration_number == o.registration_number &&
          seller_provided_legal_address == o.seller_provided_legal_address &&
          terms_of_service == o.terms_of_service &&
          vat_details == o.vat_details
    end
    ...
    def hash
      [email, fax, imprint, legal_contact_first_name, legal_contact_last_name, name, phone, registration_number, seller_provided_legal_address, terms_of_service, vat_details].hash
    end
