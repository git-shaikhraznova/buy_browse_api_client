...
module BuyBrowseApiClient
  ...
  class BuyingOptionDistribution
    # Container that returns the buying option type. This will be AUCTION or FIXED_PRICE or both. For details, see buyingOptions.
    attr_accessor :buying_option

    # The number of items having this buying option.
    attr_accessor :match_count

    # The HATEOAS reference for this buying option.
    attr_accessor :refinement_href
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::BuyingOptionDistribution` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::BuyingOptionDistribution`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'buying_option')
        self.buying_option = attributes[:'buying_option']
      end
      ...
      if attributes.key?(:'refinement_href')
        self.refinement_href = attributes[:'refinement_href']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          buying_option == o.buying_option &&
          match_count == o.match_count &&
          refinement_href == o.refinement_href
    end
    ...
    def hash
      [buying_option, match_count, refinement_href].hash
    end
