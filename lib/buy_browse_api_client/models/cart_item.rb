...
module BuyBrowseApiClient
  ...
  class CartItem
    ...
    attr_accessor :cart_item_subtotal
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CartItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CartItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'cart_item_id')
        self.cart_item_id = attributes[:'cart_item_id']
      end

      if attributes.key?(:'cart_item_subtotal')
        self.cart_item_subtotal = attributes[:'cart_item_subtotal']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          cart_item_id == o.cart_item_id &&
          cart_item_subtotal == o.cart_item_subtotal &&
          image == o.image &&
          item_id == o.item_id &&
    ...
    def hash
      [cart_item_id, cart_item_subtotal, image, item_id, item_web_url, price, quantity, title].hash
    end
