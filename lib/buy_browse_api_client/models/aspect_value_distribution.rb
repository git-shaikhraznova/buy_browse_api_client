...
module BuyBrowseApiClient
  ...
  class AspectValueDistribution
    ...
    attr_accessor :localized_aspect_value
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::AspectValueDistribution` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AspectValueDistribution`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'localized_aspect_value')
        self.localized_aspect_value = attributes[:'localized_aspect_value']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          localized_aspect_value == o.localized_aspect_value &&
    ...
    def hash
      [localized_aspect_value, match_count, refinement_href].hash
    end
